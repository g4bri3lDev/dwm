...
static Key keys[] = {
	...
	{ 0, XF86XK_AudioPrev,		spawn,		SHCMD("playerctl --player=vlc,spotifyd,spotify previous; kill -44 $(pidof dwmblocks)") },
	{ 0, XF86XK_AudioNext,		spawn,		SHCMD("playerctl --player=vlc,spotifyd,spotify next; kill -44 $(pidof dwmblocks)") },
	{ 0, XF86XK_AudioPause,		spawn,		SHCMD("playerctl --player=vlc,spotifyd,spotify pause; kill -44 $(pidof dwmblocks)") },
	{ 0, XF86XK_AudioPlay,		spawn,		SHCMD("playerctl --player=vlc,spotifyd,spotify play; kill -44 $(pidof dwmblocks)") },
	{ 0, XF86XK_AudioStop,		spawn,		SHCMD("playerctl --player=vlc,spotifyd,spotify stop; kill -44 $(pidof dwmblocks)") },
