...
static const Rule rules[] = {
	...
	{ "Onboard",  NULL,	  NULL,	      0,	    1,		 -1,	    805,950,310,130,	  1 },
};
...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,             XK_p,      setlayout,      {.v = &layouts[9]} }, //gaplessgrid
	...
	{ 0, XF86XK_AudioPrev,		spawn,		SHCMD("playerctl --player=vlc,spotifyd,spotify previous; kill -45 $(pidof dwmblocks)") },
	{ 0, XF86XK_AudioNext,		spawn,		SHCMD("playerctl --player=vlc,spotifyd,spotify next; kill -45 $(pidof dwmblocks)") },
	{ 0, XF86XK_AudioPause,		spawn,		SHCMD("playerctl --player=vlc,spotifyd,spotify play-pause; kill -45 $(pidof dwmblocks)") },
	{ 0, XF86XK_AudioPlay,		spawn,		SHCMD("playerctl --player=vlc,spotifyd,spotify play-pause; kill -45 $(pidof dwmblocks)") },
